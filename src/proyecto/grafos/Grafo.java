...
public class Grafo {
    ...
    public void eliminarVertice(Vertice vertice) {
        if (isEmpty()) {
            ...
            System.out.println("Usuario eliminado: "+vertice.getUsername());
...
//Con este metodo se verifica si existe un puente/arco entre dos usuarios/nodos/vertices
    ...
    //Con este metodo puedo obtener la lista de los puentes al recorrer la Matriz de Adyacencia
    public void ListaPuentes(){
        if (isEmpty()){
            System.out.println("El grafo no tiene arcos");
        }else{
            System.out.println("Puentes:");
            System.out.println();
            for (int x=0;x<numNodos;x++){
                for (int i=0;i<numNodos;i++){
                    //System.out.println("Matriz"+"["+x+"]"+"["+i+"]"); (comando para verificar durante el desarrollo)
                    if (esPuente(x,i)){
                        Vertice User1=findVertice(x);
                        Vertice User2=findVertice(i);
                        System.out.println("Username: "+User1.getUsername()+"("+User1.getId()+")"+", Username: "+User2.getUsername()+"("+User2.getId()+")"+", Peso: "+MatrizAd[x][i]);
                    }
    ...
    //Con este metodo puedo imprimir la lista de vertices, utilizado principalmente para el desarrollo
    public void ListaVertices(){
        if (isEmpty()){
            System.out.println("El grafo no contiene vertices");
        }else{
    ...
    //Con este metodo puedo encontrar un vertice dentro del array segun su Username
    ...
    //Con este metodo puedo encontrar un vertice dentro del array segun su ID 
    public Vertice findVertice(int num) {
        for (int i = 0; i < numNodos; i++) {
            if (vertices[i] != null) {
                if (vertices[i].getId()==num) {
                    return vertices[i];
                }
            }
        }
    ...
    //Con este metodo verifico al recorrer el array de vertices, si existe o no uno con el nombre indicado. Devuelve un bool
